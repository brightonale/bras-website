    ...
    <div className="page-container animate-fade-in">
      ...
      <div className="page-header">
        ...
        <p className="page-header__subtitle">
          Everything you need to know about Brighton&apos;s most discerning group of pint inspectors.
        </p>
      </div>
      ...
      <div className="section-card" style={{ maxWidth: '800px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
            ...
            <div>
              <strong style={{ color: 'var(--text-color)', fontFamily: 'var(--font-heading)' }}>Pub Crawls &amp; Tastings</strong>
